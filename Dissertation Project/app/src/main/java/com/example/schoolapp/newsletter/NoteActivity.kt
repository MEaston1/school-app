package com.example.schoolapp.newsletter
...
import kotlinx.android.synthetic.main.news_content_main.*
...
class NoteActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        // as the a parent activity is specified in AndroidManifest.xml.
    ...
    override fun onPrepareOptionsMenu(menu: Menu?): Boolean {
        if(notePosition >= DataManager.notes.lastIndex) {
            ...
            if(menuItem != null) {
                menuItem.icon = ResourcesCompat.getDrawable(getResources(), R.drawable.ic_block_white_24dp, null)
            }
        }
